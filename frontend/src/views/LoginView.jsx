...
const LoginView = () => {
  ...
  const [username, setUsername] = useState('Seraphim Dawn');
  ...
  return (
    <div className="min-h-screen bg-[#0B0E14] text-slate-100 flex flex-col justify-center items-center p-4 relative overflow-hidden font-sans select-none">
      ...
      {/* Main Login Card */}
      <div className="z-10 w-full max-w-[420px] bg-card-slate border border-[#1F2937]/80 rounded-lg p-8 shadow-[0_20px_50px_rgba(0,0,0,0.5),0_0_20px_rgba(139,171,255,0.03)] relative overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <button
            type="submit"
            className="w-full bg-accent-blue hover:bg-accent-blue/90 text-dark-slate font-extrabold text-sm uppercase py-4 rounded shadow-blue-glow hover:shadow-blue-glow-hover transition-all flex items-center justify-center gap-2.5 tracking-wider mt-4"
          >
            Begin Quest ⚔️
          </button>
        </form>
