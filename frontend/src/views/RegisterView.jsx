...
const RegisterView = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    register(heroName, email, phrase);
    navigate('/');
  };
  ...
  return (
    <div className="min-h-screen bg-[#0B0E14] text-slate-100 flex flex-col justify-center items-center p-4 relative overflow-hidden font-sans select-none">
      ...
      {/* Main Register Box */}
      <div className="z-10 w-full max-w-[440px] bg-card-slate border border-[#1F2937]/80 rounded-lg p-8 shadow-[0_20px_50px_rgba(0,0,0,0.6),0_0_30px_rgba(139,171,255,0.02)] relative overflow-hidden">
